...
class Doc:
    def __init__(self, college, college_type, program_type, has_markup):
    ...
    def save_concatenated_html(self):
        ...
        markup_status = 'markup' if self.has_markup else 'no_markup'
        output_dir = f'showcases/{self.college_type}_showcases/{self.college}/{markup_status}/'
    ...
    def save_proposals_in_department(self, department, action):
        ...
        markup_status = 'markup' if self.has_markup else 'no_markup'
        output_dir = f'showcases/{self.college_type}_showcases/{self.college}/{markup_status}/{department}/{action}/'
        os.makedirs(output_dir, exist_ok=True)
    ...
    def save_currrent_showcase(self, current_showcase_html, department, corresponding_dprog, action):
        ...
        markup_status = 'markup' if self.has_markup else 'no_markup'
        output_dir = f'showcases/{self.college_type}_showcases/{self.college}/{markup_status}/{department}/{action}/{corresponding_dprog}/'
